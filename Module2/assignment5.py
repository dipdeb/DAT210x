...
#
hdrs = ['education', 'age', 'capital-gain', 'race', 'capital-loss', 'hours-per-week', 'sex', 'classification']
census_df = pd.read_csv('/home/dipanjan/DAT210x/Module2/Datasets/census.data', names=hdrs)
