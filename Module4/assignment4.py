...
iso = manifold.Isomap(n_components=3, n_neighbors=8)
T = iso.fit_transform(df)
#Plot2D(T, 'isomap / 2 components (n_neighbors=8)', 0, 1)
#Plot2D(T, 'isomap / 2 components (n_neighbors=8)', 1, 2)
Plot3D(T, 'isomap / 2 components (n_neighbors=8)', 0, 1, 2)
